...
import { Add, ArrowDown2, Logout, User } from "iconsax-react";
      ...
      <Menu>
        {({ close }) => (
          <Fragment>
            ...
            >
              <Menu.Items className="absolute right-2 top-14 mt-2 p-2 min-w-[244px] h-fit origin-top-right bg-white dark:bg-dark shadow-lg border-[1.5px] border-slate-200 dark:border-neutral-800 rounded-lg focus:outline-none space-y-3">
                <Menu.Item
                  as={Link}
                  href="/account"
