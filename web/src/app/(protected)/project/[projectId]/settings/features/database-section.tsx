...
export const DatabaseSection = (props: Props) => {
  ...
  const dbImage = databases.find((d) => d.name.toLowerCase() === project?.database.toLowerCase());
  ...
  return (
    <Fragment>
      {showHR && <hr className='h-[1px] bg-slate-100 dark:bg-neutral-800 border-0 outline-none my-8' />}
      <TitleSection
        title='Database'
        ...
        <form onSubmit={handleSubmit} className='space-y-6 w-full lg:w-[100%]'>
          ...
          >
            <div className='flex flex-col justify-center items-center relative'>
              <Image src={dbImage?.url!} alt='' width={40} height={40} className='h-[40px] w-[40px]' />
          ...
          <CustomInput
            ...
            readOnly
            value={getValue('name')}
            endIcon={<PasswordEye isVisible={isVisible.indexOf('name') !== -1} onClick={() => updateVisible('name')} />}
          />
          ...
          <CustomInput
            ...
            disabled
            value={getValue('host')}
            endIcon={<PasswordEye isVisible={isVisible.indexOf('host') !== -1} onClick={() => updateVisible('host')} />}
          />
          ...
          {config.dbType !== 'mongodb' ? (
            <CustomInput
              ...
              value={getValue('port')}
              endIcon={
                <PasswordEye isVisible={isVisible.indexOf('port') !== -1} onClick={() => updateVisible('port')} />
              }
            />
          ) : null}
          ...
          <CustomInput
            ...
            endIcon={
              <PasswordEye isVisible={isVisible.indexOf('username') !== -1} onClick={() => updateVisible('username')} />
            }
          />
          <CustomInput
            ...
            endIcon={
              <PasswordEye isVisible={isVisible.indexOf('password') !== -1} onClick={() => updateVisible('password')} />
            }
          />
