...
const projectButtonVariants = cva(
  "inline-flex items-center justify-center rounded-lg font-semibold ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-800 hover:scale-[1.02] active:scale-[0.98] shadow-sm",
  {
    variants: {
      variant: {
        solid: "bg-project-primary text-white hover:bg-project-primary-90",
        faded: "bg-project-primary-10 text-project-primary hover:bg-project-primary-20",
        outline:
          "border  border-project-primary bg-transparent hover:bg-project-primary-10 text-project-primary",
        ghost: "hover:bg-project-primary-10 text-project-primary shadow-none",
      },
      size: {
...
const ProjectButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
